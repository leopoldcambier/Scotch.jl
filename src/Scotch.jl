...
# Define before execution, for instance in your /~.juliarc.jl add the following line
# const SCOTCH_LIBSCOTCH = "/path/to/scotch/lib/libscotch.dylib"
const libscotch = Main.SCOTCH_LIBSCOTCH
